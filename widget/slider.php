<div id="homepage-slider" class="carousel slide" data-ride="carousel">
  ...
  <ol class="carousel-indicators">
    ...
    <li data-target="#homepage-slider" data-slide-to="3"></li>
  </ol>

  <!-- Wrapper for slides -->
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="http://turkey-trip.com/images/goreme-balloons3.jpg" alt="Chania">
    </div>

    <div class="item">
      <img src="http://i.imgur.com/picNpgx.jpg" alt="Chania">
    </div>
